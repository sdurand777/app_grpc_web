...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayRepeatHello = channel.unary_stream(
                ...
                request_serializer=helloworld__pb2.RepeatHelloRequest.SerializeToString,
                response_deserializer=helloworld__pb2.HelloReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SayRepeatHello': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=helloworld__pb2.RepeatHelloRequest.FromString,
                    response_serializer=helloworld__pb2.HelloReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def SayRepeatHello(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/helloworld.Greeter/SayRepeatHello',
            helloworld__pb2.RepeatHelloRequest.SerializeToString,
            helloworld__pb2.HelloReply.FromString,
            options,
            channel_credentials,
            insecure,
