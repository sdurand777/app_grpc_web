...
export class BackgroundController {
    constructor(renderer, logoPath = './IVM.jpg') {
        ...
        this.themes = {
            ...
            default: {
                name: 'Default', 
                opacity: 0.3,
                backgroundColor: [0.39, 0.39, 0.39, 0.8],
                buttonColor: '#ff6600',
            ...
            brighter: {
                name: 'Brighter',
                opacity: 0.4,
                backgroundColor: [0.6, 0.6, 0.6, 0.8],
                buttonColor: '#ff6600',
                inactiveColor: '#194F8C'
            }
        };
    ...
    setTheme(themeKey) {
        ...
        // Mettre à jour la couleur de fond du renderer
        const [r, g, b, a] = theme.backgroundColor;
        this.renderer.setClearColor(r, g, b, a);
        
        // Ajouter le nouveau logo avec la nouvelle opacité
        setTimeout(() => {
            setBackgroundLogo(this.renderer, this.logoPath, theme.opacity, 0.8);
        }, 50);
